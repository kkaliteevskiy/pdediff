...
def pt(x, t):
    ...
    mvn1 = MultivariateNormal(tensor([-2.0]), (0.5**2 + var_t).reshape((1,1)))
    mvn2 = MultivariateNormal(tensor([2.0]), (0.5**2 + var_t).reshape((1,1)))
...
def sample_pt(t, n):
    mu1, mu2 = -2.0, 2.0
    var1_t, var2_t = 0.5**2 + sigmas2_total[t], 0.5**2 + sigmas2_total[t]
